...
export function JsonLd() {
  ...
  const articleSchema = {
    ...
    "description": "Research findings on how frontier models (GPT-5, Gemini 3, Claude Opus 4.6) maintain logic calibration but collapse in metacognitive sensitivity during adversarial code tasks.",
    "author": [
      {
        "@type": "Person",
        "name": "Adedoyinsola Ogungbesan"
